            ...
            public:
                ...
                void createStatements(const X86Instruction* instr, core::ir::Program* program)
                {
                    ...
                    case UD_Icmovs:
                    {
                        ...
                        {
                        case UD_Icmova:
                            _[jump(~below_or_equal, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovae:
                            _[jump(~cf, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovb:
                            _[jump(cf, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovbe:
                            ...
                            break;
                        case UD_Icmovz:
                            _[jump(zf, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovg:
                            _[jump(~less_or_equal, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovge:
                            _[jump(~less, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovl:
                            _[jump(less, then.basicBlock(), directSuccessor())];
                            break;
                        ...
                        case UD_Icmovnz:
                            ...
                            break;
                        case UD_Icmovno:
                            _[jump(~of, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovnp:
                            _[jump(~pf, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovns:
                            _[jump(~sf, then.basicBlock(), directSuccessor())];
                            break;
                        case UD_Icmovo:
                            _[jump(of, then.basicBlock(), directSuccessor())];
                            break;
