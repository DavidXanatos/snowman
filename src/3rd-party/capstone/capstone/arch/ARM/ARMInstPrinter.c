...
void ARM_printInst(MCInst* MI, SStream* O, void* Info)
{
    ...
    case ARM_t2HINT:
        ...
        case 0:
            ...
            pubOpcode = ARM_INS_NOP;
            break;
        case 1:
            SStream_concat0(O, "yield");
            pubOpcode = ARM_INS_YIELD;
            break;
        case 2:
            SStream_concat0(O, "wfe");
            pubOpcode = ARM_INS_WFE;
            break;
        case 3:
            SStream_concat0(O, "wfi");
            pubOpcode = ARM_INS_WFI;
            break;
        case 4:
            SStream_concat0(O, "sev");
            pubOpcode = ARM_INS_SEV;
            break;
        case 5:
...
static void printMSRMaskOperand(MCInst* MI, unsigned OpNum, SStream* O)
{
    ...
    if(ARM_getFeatureBits(MI->csh->mode) & ARM_FeatureMClass)
    {
        ...
        case 0x800:
            ...
            return; // with _nzcvq bits is an alias for aspr
        case 0x400:
        ...
        case 0x801:
            ...
            return; // with _nzcvq bits is an alias for iapsr
        case 0x401:
        ...
        case 0x802:
            ...
            return; // with _nzcvq bits is an alias for eapsr
        case 0x402:
        ...
        case 0x803:
            ...
            return; // with _nzcvq bits is an alias for xpsr
        case 0x403:
